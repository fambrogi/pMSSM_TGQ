...
lista=  open('/scratch/fambrogi/PMSSM_TGQ/GitHub_Repo/pMSSM_TGQ/SLHA_LISTS/Missing_Points_' + WHAT + '.txt').readlines()
...
np.save('Numpys_All/Excluded_Before_Not_Now_'+WHAT , Old)
