...
\abstract{The ATLAS collaboration at the Large Hadron Collider (LHC) analised in \href{https://arxiv.org/abs/1508.06608}{arXiv:1508.06608} the constraints provided by the Run 1 searches, performed at 8 TeV centre-of-mass energy, on a 19-parameters realisation of the phenomenological Minimal Supersymmeric Standard Model (pMSSM). It was shown in \href{https://arxiv.org/abs/1707.09036}{arXiv:1707.09036} that a large fraction of the parameter space of this model can be efficiently constrained by means of simplified models speactra (SMS) results. The uncovered parameter space can be potentially constrained by extending the interpretation of the existing searches from the ATLAS and CMS collaborations to SMS that are not currently covered. This work aims at demonstrating that by recasting estisting searches with a simplifiied model signature as simple as 3jets + \MET~ extends significantly the constraining power of SMS results on the pMSSM-19.}
