...
Res_ALL        = { 'Dics':[] , 'INFO' : 'Containing only results for analised points' } # I cant save arrays to a numpy dictionary!
Res_ATLAS02eff = { 'Dics':[] , 'INFO' : 'Containing only results for analised points' }
Masses          = {'SLHA':[] , 'Glu':[] , 'Neu':[] , 'Light_S':[] , 'INFO':'Containing only results for analised points'}
Masses_Excluded = {'SLHA':[] , 'Glu':[] , 'Neu':[] , 'Light_S':[] , 'INFO':'Containing only results for analised points'} 
...
np.save('NEW_Results_ALL_'     + WHAT , Res_ALL )
np.save('NEW_Results_ATLAS02_' + WHAT , Res_ATLAS02eff )
np.save('NEW_Masses_'         + WHAT  , Masses )
