...
\newcommand{\MA}{\texttt {MadAnalysis5}}
...
\end{center}
\caption{Top panel: \SMO~ $r$ values for the points excluded by the newly implemented EM results, for the Bino-like LSP in the $(m_{\tilde{g}},min(m_{\tilde q}))$ (left) and $(m_{\tilde{g}}, m_{\tilde{g}} - m_{\tilde \chi _1 ^0 })$ mass planes (right). Bottom panel: Contribution of the \textit{T1}, \textit{T2}, \textit{T5} and \textit{T3GQ} simplified model results and their combination for the analysis ATLAS-SUSY-2013-02, as a function of \MGLU.} 
\label{rValues}
\end{figure*}
...
\begin{figure*}[!]
	...
	\end{center}
	\caption{Top panel: Fractional contribution of the model with the highest $r$ value to the total rvalue. Points in dark blue benefit from the combination of the three results for \textit{T2}, \textit{T5} and XXXXXX. Bottom panel: distribution of the $r$ values for excluded points, considering single SMS or combinations, for the analysis ATLAS-SUSY-2013-02.} 
\end{figure*}
...
\begin{figure*}[!]
	...
	\end{center}
	\caption{$r$ value distribution for the \textit{T2}, \textit{T5}, \textit{T3GQ} and their combination for the points excluded using the ATLAS-SUSY-2013-02 analysis alone, for the Bino-like LSP. In grey, the points for which $r$ value $\leq$ 1 are shown.} 
	\label{rvalues-bino}
\end{figure*}
\\
